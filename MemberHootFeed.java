...
public class MemberHootFeed
{
	...
	public void viewMemberHootFeed(String user, Subscription subs)throws FileNotFoundException, IOException{
		...
		while (line != null) {
			...
			if(subs.searchSub(uname, user) == true){
	...
	/*public void viewMemberHootFeed()throws FileNotFoundException, IOException{
